          ...
          <s.ProjectWrapper>
            ...
            <s.Project>
              ...
              >
                ...
                <s.ProjectInfo>
                  <s.ProjectName $toggle={dddevToggle}>
                    dddev
                    <ExpandMoreIcon />
                    <s.GithubLink
              ...
              <s.ProjectMoreWrapper $toggle={dddevToggle}>
                <s.ProjectMore ref={dddevMoreRef}>
                  ...
                  <s.ProjectPart>
                    ...
                    <s.ProjectPartItem>
                      ...
                      기존 웹 소켓 서버와 Quill에서 지원하지 않는 실시간 멤버 확인 기능, 사용자 영역 잠금 기능, 실시간 작성자 위치 태그, DB 연동 등의
                      기능을 추가 구현 하였습니다.
                    </s.ProjectPartItem>
                  </s.ProjectPart>
                  <s.ProjectCategory>
                  ...
                  <s.ProjectInsight className="insight">
            ...
            <s.Project $toggle={nashdaToggle}>
              ...
              >
                ...
                <s.ProjectInfo>
                  <s.ProjectName $toggle={nashdaToggle}>
                    내쉬다
                    <ExpandMoreIcon />
                    <s.GithubLink
              ...
              <s.ProjectMoreWrapper $toggle={nashdaToggle}>
                <s.ProjectMore ref={nashdaMoreRef}>
                  ...
                  <s.ProjectHighlight $toggle={nashdaHighlightToggle}>
                    ...
                    <s.ProjectHighlightItem>
                      <s.ProjectHightlightTitle>주간 시험 : </s.ProjectHightlightTitle>위 3가지 연습 및 놀이를 통합하여 주간 테스트를 진행할 수 있으며
                      이를 통해 사용자의 발음 수준 및 재활 진행도를 파악할 수 있다.
                    </s.ProjectHighlightItem>
                    <s.ProjectHighlightItem>
                    ...
                    <s.ProjectHighlightItem>
                      ...
                      4가지 정보를 확인할 수 있다. 사용자가 많이 틀린 발음 순 통계, 주간 시험의 분석 결과를 정답과 발음 복습을 통해 확인, 대화 연습의
                  ...
                  <s.ProjectPart>
                    <s.ProjectPartItem>
                      <s.ProjectPartTitle>프로젝트 기획 : </s.ProjectPartTitle>
                      프로젝트의 시작은 가족의 재활 과정 중 불편함을 바로 옆에서 지켜보고 느낀 작은 불편함이었습니다. 본인의 아이디어 이기에 책임감을
                      가지고 기획에 중심이 되어 프로젝트를 진행 하였습니다.
                    </s.ProjectPartItem>
                    <s.ProjectPartItem>
                    ...
                    <s.ProjectPartItem>
                      <s.ProjectPartTitle>API 객체 관리 : </s.ProjectPartTitle>웹 JWT 의 토큰 유효성과 보안을 확보하기 위해 전체 API를 객체로 관리하여
                      코드를 간결하게 함과 동시에 재사용성 및 효율성을 높였습니다.
                    </s.ProjectPartItem>
                    <s.ProjectPartItem>
                      <s.ProjectPartTitle>사용자 페이지 : </s.ProjectPartTitle>웹 사용자 정보 조회 및 수정, QnA, 통계 조회 등이 가능한 사용자 페이지를
                      구현.
                    </s.ProjectPartItem>
                  </s.ProjectPart>
                  <s.ProjectCategory>
            ...
            <s.Project $toggle={stvdyToggle}>
              ...
              >
                ...
                <s.ProjectInfo>
                  <s.ProjectName $toggle={stvdyToggle}>
                    STVDY
                    <ExpandMoreIcon />
                    <s.GithubLink
              ...
              <s.ProjectMoreWrapper $toggle={stvdyToggle}>
                <s.ProjectMore ref={stvdyMoreRef}>
                  ...
                  <s.ProjectStack>프레임워크 : Vue3 / 상태 관리 : pinia / 기능 구현 및 API 객체 구현 : Javascript / 포맷팅 : Prettier</s.ProjectStack>
                  <s.ProjectCategory>
                    <s.HistoryDiv />
                    기여
                  </s.ProjectCategory>
                  <s.ProjectPart>
                    ...
                    <s.ProjectPartItem>
                      ...
                      새로운 질문 등을 확인할 수 있는 메인페이지를 구현. 다양한 플랫폼의 메인처럼 한눈에 최신 동향을 한눈에 확인 가능하도록 레이아웃을
                      구성하였습니다.
                    </s.ProjectPartItem>
                    <s.ProjectPartItem>
          ...
          <s.ProjectWrapper>
            ...
            <s.Project $toggle={markaToggle}>
              ...
              >
                ...
                <s.ProjectInfo>
                  <s.ProjectName $toggle={markaToggle}>
                    Marka
                    <ExpandMoreIcon />
                    <s.GithubLink
              ...
              <s.ProjectMoreWrapper $toggle={markaToggle}>
                <s.ProjectMore ref={markaMoreRef}>
                  ...
                  <s.ProjectInsight className="insight">
                    ...
                    <span>
                      &nbsp;더블클릭으로 단어 선택 시 trailing space가 따라오는 브라우저의 기본동작을 이해하기 어려웠다. 사용자 경험을 낮추는 요인이라
                      판단, 서칭으로는 원하는 결과를 찾을 수 없어 직접 js, css를 적절히 섞어 구현하였다.&nbsp;/ 처음 1인 프로젝트로 풀스택 개발을 한
                      의미 있는 프로젝트였다.
                    </span>
                  </s.ProjectInsight>
                </s.ProjectMore>
            ...
            <s.Project $toggle={polorsToggle}>
              ...
              >
                ...
                <s.ProjectInfo>
                  <s.ProjectName $toggle={polorsToggle}>
                    POLORS
                    <ExpandMoreIcon />
                    <s.GithubLink
              ...
              <s.ProjectMoreWrapper $toggle={polorsToggle}>
                <s.ProjectMore ref={polorsMoreRef}>
                  ...
                  <s.ProjectHighlight $toggle={polorsHighlightToggle}>
                    ...
                    <s.ProjectHighlightItem>
                      ...
                      매일 자정 새로운 이미지가 업로드되며 색상 스키마가 자동으로 생성된다. cron을 활용하여 자동화하였으며 에러와 관련된 로그를 파일로
                      리다이렉션 하여 에러를 추적할 수 있도록 하였다.
                    </s.ProjectHighlightItem>
                    <s.ProjectHighlightItem>
                  ...
                  <s.ProjectInsight>
                    ...
                    <span>
                      &nbsp;크롤링 시에는 가상 브라우저 내에서 실행되는 코드와 서버에서 실행되는 코드를 잘 분리해야 했다. 코드가 실행되는 시점에 대한
                      좋은 공부가 되었다.&nbsp;
                    </span>
